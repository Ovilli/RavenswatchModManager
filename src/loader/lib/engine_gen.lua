...
return {
  ...
  ["GameModifierUi_PadSelectedSlots"] = { pattern = "GameModifierUi_PadSelectedSlots", offset = 0x0, sig = "vppp" },
  ["GroupLevelComponent_Ctor"] = { pattern = "GroupLevelComponent_Ctor", offset = 0x0, sig = "pp" },
  ["HeroController_AddSkill"] = { pattern = "HeroController_AddSkill", offset = 0x0, sig = "vpp" },
  ["HeroController_Ctor"] = { pattern = "HeroController_Ctor", offset = 0x0, sig = "pp" },
  ["HeroController_RemoveSkill"] = { pattern = "HeroController_RemoveSkill", offset = 0x0, sig = "vppi" },
  ...
  ["SceneContextValue_SetBool"] = { pattern = "SceneContextValue_SetBool", offset = 0x0, sig = "vpui" },
  ["SceneContextValue_SetFloat"] = { pattern = "SceneContextValue_SetFloat", offset = 0x0, sig = "vpuf" },
  ["SceneContextValue_SetInt"] = { pattern = "SceneContextValue_SetInt", offset = 0x0, sig = "vpui" },
  ["SharedRef_Release"] = { pattern = "SharedRef_Release", offset = 0x0, sig = "vp" },
  ["SkillController_SetTier"] = { pattern = "SkillController_SetTier", offset = 0x0, sig = "vpi" },
  ["SkinGrid_Populate"] = { pattern = "SkinGrid_Populate", offset = 0x0, sig = "vpp" },
  ["String_Assign"] = { pattern = "String_Assign", offset = 0x0, sig = "vpp" },
  ["TileKindPool_ReportEmpty"] = { pattern = "TileKindPool_ReportEmpty", offset = 0x0, sig = "vpp" },
  ["TileSpawn_DistanceConstraints"] = { pattern = "TileSpawn_DistanceConstraints", offset = 0x0, sig = "vpp" },
  ["TileSpawn_PlaceTiles"] = { pattern = "TileSpawn_PlaceTiles", offset = 0x0, sig = "vp" },
  ["TileSpawner_Spawn"] = { pattern = "TileSpawner_Spawn", offset = 0x0, sig = "vp" },
  ...
  ["Vector_InsertRange"] = { pattern = "Vector_InsertRange", offset = 0x0, sig = "ppuu" },
