...
// AnalyticsBag_SetInt_Pattern omitted: status=unverified
constexpr std::uintptr_t AnalyticsBag_SetString = 0x140201c10ull;
// AnalyticsBag_SetString_Pattern omitted: status=unverified
constexpr std::uintptr_t Analytics_EmitActiveBoss = 0x1401f9170ull;
// Analytics_EmitActiveBoss_Pattern omitted: status=unverified
constexpr std::uintptr_t Analytics_EmitChapterEnd = 0x1401f5c70ull;
// Analytics_EmitChapterEnd_Pattern omitted: status=unverified
constexpr std::uintptr_t Analytics_EmitHeroDeath = 0x1401f6e50ull;
// Analytics_EmitHeroDeath_Pattern omitted: status=unverified
constexpr std::uintptr_t Analytics_EmitObjectProposed = 0x1401f7760ull;
// Analytics_EmitObjectProposed_Pattern omitted: status=unverified
constexpr std::uintptr_t Analytics_EmitObjectSelected = 0x1401f79c0ull;
// Analytics_EmitObjectSelected_Pattern omitted: status=unverified
constexpr std::uintptr_t Analytics_EmitOpenChest = 0x1401f8f30ull;
// Analytics_EmitOpenChest_Pattern omitted: status=unverified
constexpr std::uintptr_t Analytics_EmitSandmanBuy = 0x1401f6800ull;
// Analytics_EmitSandmanBuy_Pattern omitted: status=unverified
constexpr std::uintptr_t Analytics_EmitSkillProposed = 0x1401f7120ull;
// Analytics_EmitSkillProposed_Pattern omitted: status=unverified
constexpr std::uintptr_t Analytics_EmitSkillSelected = 0x1401f7440ull;
// Analytics_EmitSkillSelected_Pattern omitted: status=unverified
...
// EnemyCamp_Stage3Filter_Pattern omitted: status=unverified
...
// Enemy_RuntimeSpawnPicker_Pattern omitted: status=unverified
...
// Component_GetTypeId_Pattern omitted: status=unverified
constexpr std::uintptr_t Controller_GetFieldByKey = 0x140396df0ull;
// Controller_GetFieldByKey_Pattern omitted: status=unverified
...
// CustomFlagList_Serialize_Pattern omitted: status=unverified
...
// Profiler_GetThreadScopeStack_Pattern omitted: status=unverified
...
constexpr std::uintptr_t ResourceRef_Serialize = 0x1401c8e60ull;
constexpr const char* ResourceRef_Serialize_Pattern = "ResourceRef_Serialize";
constexpr std::uintptr_t Serializer_GetClassVersion = 0x1404fce50ull;
constexpr const char* Serializer_GetClassVersion_Pattern = "Serializer_GetClassVersion";
constexpr std::uintptr_t Serializer_ReadEnum = 0x14020c450ull;
constexpr const char* Serializer_ReadEnum_Pattern = "Serializer_ReadEnum";
constexpr std::uintptr_t Serializer_ReadObjectNamed = 0x140500d70ull;
// Serializer_ReadObjectNamed_Pattern omitted: status=unverified
constexpr std::uintptr_t Serializer_ReadObjectPayload = 0x1405006d0ull;
// Serializer_ReadObjectPayload_Pattern omitted: status=unverified
...
constexpr std::uintptr_t Serializer_ReadVectorObjIds = 0x1402f3cf0ull;
constexpr const char* Serializer_ReadVectorObjIds_Pattern = "Serializer_ReadVectorObjIds";
constexpr std::uintptr_t Serializer_ReadVectorU32 = 0x140364270ull;
constexpr const char* Serializer_ReadVectorU32_Pattern = "Serializer_ReadVectorU32";
constexpr std::uintptr_t Serializer_ReadVectorU8 = 0x1403646c0ull;
constexpr const char* Serializer_ReadVectorU8_Pattern = "Serializer_ReadVectorU8";
constexpr std::uintptr_t Serializer_ResolveObjectId = 0x140500630ull;
// Serializer_ResolveObjectId_Pattern omitted: status=unverified
...
// Entity_AllocInstance_Pattern omitted: status=unverified
...
// Entity_FindMagicalObjectComponent_Pattern omitted: status=unverified
...
constexpr std::uintptr_t Hero_ModifyDreamShards = 0x14039a320ull;
constexpr const char* Hero_ModifyDreamShards_Pattern = "Hero_ModifyDreamShards";
constexpr std::uintptr_t HitPoint_SetHitPoints = 0x140822db0ull;
constexpr const char* HitPoint_SetHitPoints_Pattern = "HitPoint_SetHitPoints";
...
// InitialLoading_SpawnMagicalObjects_Pattern omitted: status=unverified
constexpr std::uintptr_t MagicalObjectPool_Grow = 0x140156de0ull;
// MagicalObjectPool_Grow_Pattern omitted: status=unverified
constexpr std::uintptr_t MagicalObjectPool_SourceLookup = 0x14025e3e0ull;
// MagicalObjectPool_SourceLookup_Pattern omitted: status=unverified
...
// Definition_Unload_Pattern omitted: status=unverified
...
constexpr std::uintptr_t Library_AchievementDefinition_vftable = 0x140f27660ull;
constexpr std::uintptr_t Library_ChallengeDefinition_vftable = 0x140f299d8ull;
constexpr std::uintptr_t Library_DreamShardDefinition_vftable = 0x140f27178ull;
constexpr std::uintptr_t Library_EnemyCampDifficultyDefinition_vftable = 0x140f280e0ull;
constexpr std::uintptr_t Library_EnemyCampTierDefinition_vftable = 0x140f2ad30ull;
constexpr std::uintptr_t Library_EnemyDefinition_vftable = 0x140f2b450ull;
constexpr std::uintptr_t Library_EnemyTribeDefinition_vftable = 0x140f2aeb8ull;
constexpr std::uintptr_t Library_EntitySettingsResource_vftable = 0x140f75e60ull;
constexpr std::uintptr_t Library_GameModifierDefinition_vftable = 0x140f2a960ull;
constexpr std::uintptr_t Library_IngredientDefinition_vftable = 0x140f29a18ull;
constexpr std::uintptr_t Library_MapDefinition_vftable = 0x140f29810ull;
constexpr std::uintptr_t Library_MelodyDefinition_vftable = 0x140f29af8ull;
constexpr std::uintptr_t Library_RewardDefinition_vftable = 0x140f298a8ull;
constexpr std::uintptr_t Library_TileDefinition_vftable = 0x140f2b0e0ull;
constexpr std::uintptr_t Library_VersionDefinition_vftable = 0x140f297c0ull;
...
constexpr std::uintptr_t TileDef_Deserialize = 0x140324690ull;
// TileDef_Deserialize_Pattern omitted: status=unverified
...
constexpr std::uintptr_t Fcm2_OnClosedConnection = 0x140ac94a0ull;
constexpr const char* Fcm2_OnClosedConnection_Pattern = "Fcm2_OnClosedConnection";
...
// Netcode_ConnectionFactory_Pattern omitted: status=unverified
constexpr std::uintptr_t Netcode_ConnectionRegistry_Emplace = 0x140b2fd80ull;
// Netcode_ConnectionRegistry_Emplace_Pattern omitted: status=unverified
...
// Netcode_EntityReplSetup_Pattern omitted: status=unverified
...
// Netcode_SessionCtx_LocalGuid_Pattern omitted: status=unverified
constexpr std::uintptr_t P2PSession_OnFcm2NewHost = 0x1408b8530ull;
constexpr const char* P2PSession_OnFcm2NewHost_Pattern = "P2PSession_OnFcm2NewHost";
constexpr std::uintptr_t P2PSession_SetState = 0x14085ca70ull;
constexpr const char* P2PSession_SetState_Pattern = "P2PSession_SetState";
constexpr std::uintptr_t P2PSession_StateNames = 0x140eece10ull;
constexpr std::uintptr_t RakNetConnection_Ctor = 0x140b9cd50ull;
// RakNetConnection_Ctor_Pattern omitted: status=unverified
constexpr std::uintptr_t RakPeer_GetGuidFromSystemAddress = 0x140ae33d0ull;
constexpr const char* RakPeer_GetGuidFromSystemAddress_Pattern = "RakPeer_GetGuidFromSystemAddress";
constexpr std::uintptr_t RakPeer_GetMyGUID = 0x140ae3280ull;
// RakPeer_GetMyGUID_Pattern omitted: status=unverified
constexpr std::uintptr_t RakPeer_GetSystemAddressFromGuid = 0x140ae3570ull;
constexpr const char* RakPeer_GetSystemAddressFromGuid_Pattern = "RakPeer_GetSystemAddressFromGuid";
constexpr std::uintptr_t RakPeer_GetSystemList = 0x140ae1700ull;
constexpr const char* RakPeer_GetSystemList_Pattern = "RakPeer_GetSystemList";
...
// BinarySaver_CollectDependencies_Pattern omitted: status=unverified
...
constexpr std::uintptr_t Definition_PreloadResourceCache = 0x140310fb0ull;
// Definition_PreloadResourceCache_Pattern omitted: status=unverified
...
// FileStream_Open_Pattern omitted: status=unverified
...
// LevelBinary_Load_Pattern omitted: status=unverified
constexpr std::uintptr_t LevelDatabase_BuildAndRegister = 0x14047cf80ull;
constexpr const char* LevelDatabase_BuildAndRegister_Pattern = "LevelDatabase_BuildAndRegister";
constexpr std::uintptr_t LevelLoad_AbortPredicate = 0x140456c70ull;
// LevelLoad_AbortPredicate_Pattern omitted: status=unverified
constexpr std::uintptr_t LevelLoad_ProgressTick = 0x140516cd0ull;
// LevelLoad_ProgressTick_Pattern omitted: status=unverified
constexpr std::uintptr_t LevelObject_DestroyVectors = 0x140476f60ull;
// LevelObject_DestroyVectors_Pattern omitted: status=unverified
...
// LevelStream_LoadLevel_Pattern omitted: status=unverified
...
// LevelText_Load_Pattern omitted: status=unverified
...
constexpr std::uintptr_t ResourceCache_Parse = 0x140492a10ull;
// ResourceCache_Parse_Pattern omitted: status=unverified
constexpr std::uintptr_t ResourceCache_Submit = 0x1404aa3a0ull;
constexpr const char* ResourceCache_Submit_Pattern = "ResourceCache_Submit";
...
// Reward_GenerateAndDistribute_Pattern omitted: status=unverified
...
// LobbyMembers_List_Pattern omitted: status=unverified
constexpr std::uintptr_t LobbyMembers_Local = 0x1409253a0ull;
// LobbyMembers_Local_Pattern omitted: status=unverified
...
// UiController_BindComponent_Pattern omitted: status=unverified
constexpr std::uintptr_t UiController_OnHide = 0x140352b40ull;
// UiController_OnHide_Pattern omitted: status=unverified
constexpr std::uintptr_t UiController_OnShow = 0x140352aa0ull;
// UiController_OnShow_Pattern omitted: status=unverified
constexpr std::uintptr_t UiController_UnbindComponent = 0x14034c200ull;
// UiController_UnbindComponent_Pattern omitted: status=unverified

// --- world ---
constexpr std::uintptr_t Chapter_Serialize = 0x1403254d0ull;
constexpr const char* Chapter_Serialize_Pattern = "Chapter_Serialize";
constexpr std::uintptr_t GameModeDefaultDef_Serialize = 0x1403256e0ull;
constexpr const char* GameModeDefaultDef_Serialize_Pattern = "GameModeDefaultDef_Serialize";
constexpr std::uintptr_t LevelStream_Deserialize = 0x1404767e0ull;
// LevelStream_Deserialize_Pattern omitted: status=unverified
constexpr std::uintptr_t MapDef_Serialize = 0x1403233b0ull;
constexpr const char* MapDef_Serialize_Pattern = "MapDef_Serialize";
...
constexpr std::uintptr_t TileKind_Serialize = 0x140340fc0ull;
constexpr const char* TileKind_Serialize_Pattern = "TileKind_Serialize";
constexpr std::uintptr_t TileSlotScenarioKindCompat_Serialize = 0x140341190ull;
constexpr const char* TileSlotScenarioKindCompat_Serialize_Pattern = "TileSlotScenarioKindCompat_Serialize";
constexpr std::uintptr_t TileSlotSettings_Serialize = 0x1403411f0ull;
constexpr const char* TileSlotSettings_Serialize_Pattern = "TileSlotSettings_Serialize";
constexpr std::uintptr_t TileSlotSize_Serialize = 0x140341780ull;
constexpr const char* TileSlotSize_Serialize_Pattern = "TileSlotSize_Serialize";
...
constexpr std::uintptr_t TileSpawnerSettings_Serialize = 0x140341b10ull;
constexpr const char* TileSpawnerSettings_Serialize_Pattern = "TileSpawnerSettings_Serialize";
