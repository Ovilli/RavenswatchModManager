// FUN_14017faa0 @ 0x14017faa0
// purpose-guess: oCSpawnableSettings_register
// callers (2):
//   FUN_140186fc0 @ 140186fc0
//   FUN_140005760 @ 140005760


void FUN_14017faa0(void)

{
  ...
  lVar1 = (longlong)DAT_1414472c0;
  if (DAT_1414472c0 == (longlong *)0x0) {
    if (DAT_1414142a7 == '\0') {
    ...
    if (lVar1 == 0) {
      ...
      DAT_1414472c0 = plVar2;
      FUN_140177100();
      (**(code **)(*plVar2 + 0xd8))(plVar2,0x60,8);
      local_40 = 0x80000013;
      *(code **)(plVar2[0x11] + 0x80) = FUN_1401a88d0;
      *(undefined1 **)(plVar2[0x11] + 0x90) = &LAB_1401a6d40;
      local_48 = "oCSpawnableSettings";
      ...
      *(undefined4 *)(plVar2 + 5) = 0xc3a5fb0;
      ...
      FUN_1404f3c70(uVar4,plVar2,FUN_1406783b0);
      lVar1 = DAT_141447120;
      if (DAT_141447120 != 0) {
        plVar2[0xc] = DAT_141447120;
        if (*(int *)(lVar1 + 0x68) == 0) {
