// FUN_1402beff0 @ 0x1402beff0
// purpose-guess: BookPageUiController_register
// callers (1):
//   FUN_140031c00 @ 140031c00


void FUN_1402beff0(void)

{
  ...
  lVar1 = (longlong)DAT_1414481f0;
  if (DAT_1414481f0 == (longlong *)0x0) {
    if (DAT_1414142a7 == '\0') {
    ...
    if (lVar1 == 0) {
      ...
      DAT_1414481f0 = plVar2;
      FUN_140234e70();
      (**(code **)(*plVar2 + 0xd8))(plVar2,0x180,8);
      local_40 = 0x80000022;
      *(undefined1 **)(plVar2[0x11] + 0x90) = &LAB_1401a6d40;
      local_48 = "oIDtEntityCpntBookPageUiController";
      ...
      *(undefined4 *)(plVar2 + 5) = 0x1768aac7;
      if (bVar3) {
        DAT_14140ded0 = FUN_1404f4ef0();
        DAT_14140ded8 = FUN_1404f4ef0();
        DAT_14140dee0 = FUN_1404f4ef0();
