// FUN_140180160 @ 0x140180160
// purpose-guess: oCEntitySpawner_register
// callers (1):
//   FUN_140005a20 @ 140005a20


void FUN_140180160(void)

{
  ...
  lVar1 = (longlong)DAT_141446ed8;
  if (DAT_141446ed8 == (longlong *)0x0) {
    if (DAT_1414142a7 == '\0') {
    ...
    if (lVar1 == 0) {
      ...
      DAT_141446ed8 = plVar2;
      FUN_14017ffd0();
      (**(code **)(*plVar2 + 0xd8))(plVar2,0x60,8);
      local_40 = 0x8000000f;
      *(code **)(plVar2[0x11] + 0x80) = FUN_1401a8970;
      *(undefined1 **)(plVar2[0x11] + 0x90) = &LAB_1401a6d40;
      local_48 = "oCEntitySpawner";
      ...
      *(undefined4 *)(plVar2 + 5) = 0x17bcd54b;
      if (bVar3) {
        DAT_14140ded0 = FUN_1404f4ef0();
        DAT_14140ded8 = FUN_1404f4ef0();
        DAT_14140dee0 = FUN_1404f4ef0();
