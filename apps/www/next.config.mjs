...
const nextConfig = {
  ...
  async headers() {
    ...
    // / googlesyndication iframes, and it beacons to google.com. Keep these in
    // sync with the loader added in layout.tsx — a missing directive shows up
    // as blank ad slots, not an error.
    const csp = process.env.NODE_ENV === 'production'
      ? [
          "default-src 'self'",
          "script-src 'self' 'unsafe-inline' https://pagead2.googlesyndication.com https://*.googlesyndication.com https://partner.googleadservices.com https://tpc.googlesyndication.com https://www.googletagservices.com https://adservice.google.com",
