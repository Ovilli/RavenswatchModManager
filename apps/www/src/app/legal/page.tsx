      ...
      <Card className="mx-auto max-w-3xl border-border/60 bg-card/80 backdrop-blur">
        ...
        <CardContent className="space-y-6 text-sm text-muted-foreground">
          <section className="space-y-2">
            ...
            <p>
              Ravenswatch Mod Manager is an open-source project maintained by contributors.
          ...
          <section className="space-y-2">
            ...
            <p>
              The source code is distributed under the terms of the license found in the
              repository. Third-party components bundled with the desktop client are listed in
              the{' '}
              <a
          ...
          <section className="space-y-2">
            ...
            <p>
              &quot;Ravenswatch&quot; is a trademark of Passtech Games. All game assets,
              trademarks, and copyrights are property of their respective owners. This mod
              manager operates on local game files and does not distribute copyrighted content.
            </p>
          </section>
        </CardContent>
      </Card>
