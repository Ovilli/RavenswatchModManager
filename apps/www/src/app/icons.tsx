export function LibraryIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Library">
      <title>Library</title>
      <rect x="3" y="4" width="18" height="16" stroke="currentColor" strokeWidth="1.8" rx="1.6" fill="currentColor" fillOpacity="0.06" />
...
export function BrowseIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Browse">
      <title>Browse</title>
...
export function ProfilesIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Profiles">
      <title>Profiles</title>
      <circle cx="12" cy="8" r="4" stroke="currentColor" strokeWidth="1.8" fill="currentColor" fillOpacity="0.06" />
...
export function ConflictsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Conflicts">
      <title>Conflicts</title>
      <path d="M10.29 3.86L1.82 12.33a2 2 0 0 0 0 2.83l7.77 7.77a2 2 0 0 0 2.83 0l8.47-8.47a2 2 0 0 0 0-2.83L13.12 3.86a2 2 0 0 0-2.83 0z" stroke="currentColor" strokeWidth="1.6" fill="currentColor" fillOpacity="0.04" />
...
export function SettingsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Settings">
...
export function AboutIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="About">
      <title>About</title>
