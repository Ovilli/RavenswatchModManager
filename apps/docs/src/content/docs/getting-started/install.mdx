...
<Tabs syncKey="os">
  <TabItem label="Windows" icon="seti:windows">
    ...
    <Aside type="tip">
    If the app won't open, install [WebView2](https://developer.microsoft.com/en-us/microsoft-edge/webview2/) — it ships with Windows 11 and most Windows 10 builds.
    </Aside>
  </TabItem>
