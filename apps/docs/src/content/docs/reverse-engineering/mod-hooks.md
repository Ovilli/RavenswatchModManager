---
title: Mod hooks
description: Where the game creates, spawns, and loads things — the moddable surface.
---

:::note
Status: **draft, derived from headless RE artifacts** under
`docs/_re/out/`. Use [GHIDRA_MCP.md](/reverse-engineering/ghidra-mcp/) to verify and
...
See [`SPAWNING.md`](/reverse-engineering/spawning/) — `Spawn(this, position, &oCEntitySpawnData)`
